...
mongoose.connect(`mongodb+srv://sushi:${process.env.KEY}@cluster0.vhiymwg.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp`,{useNewUrlParser: true, UseUnifiedTopology: true}).then(() => {
